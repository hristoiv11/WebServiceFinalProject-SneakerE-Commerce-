package com.laboneproject.inventory.utils;
...
public class GlobalControllerExceptionHandler {
    ...
    public HttpErrorInfo handleInventoryNotFoundException(HttpServletRequest request, InventoryNotFoundException ex) {
